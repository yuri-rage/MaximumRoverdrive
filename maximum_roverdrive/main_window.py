...
from PyQt5.QtWidgets import QMainWindow, QWidget, QHBoxLayout, QVBoxLayout, QFormLayout, \
    QComboBox, QPushButton, QTableView, QLineEdit, QFrame
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.lbl_filename = QLineEdit('Filename', self.central_widget)
    ...
    def __init_ui__(self):
        ...
        self.layout_utilities.addWidget(self.lbl_filename)
